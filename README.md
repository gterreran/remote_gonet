...
The original `gonet4.py` ([see here](https://github.com/Wied58/gonet4/blob/main/gonet4.py))
...
using the [astral documentation](https://astral.readthedocs.io/en/latest/).
